...
%% Channel-wise Squeezed Features
Layer2 = "concat_10_1";
...
figure
subplot(3, 4, 1)
plot(A1),title("Noisy MT data");text('Units', 'normalized', 'String', '(a)', 'Position',[0.01 0.93 0], 'FontSize', 12);
subplot(3, 4, 5)
plot(D1top_feature_maps(:, 39)),title("Dense Block");text('Units', 'normalized', 'String', '(b)', 'Position',[0.01 0.93 0], 'FontSize', 12);
subplot(3, 4, 9)
plot(D2top_feature_maps(:, 20)),title("Dense Block");text('Units', 'normalized', 'String', '(c)', 'Position',[0.01 0.93 0], 'FontSize', 12);
subplot(3, 4, 2)
plot(CSLtop_feature_maps(:, 1)),title("CSL module");text('Units', 'normalized', 'String', '(d)', 'Position',[0.01 0.93 0], 'FontSize', 12);
subplot(3, 4, 6)
plot(SPPtop_feature_maps(:, 3)),title("SPP module");text('Units', 'normalized', 'String', '(e)', 'Position',[0.01 0.93 0], 'FontSize', 12);
subplot(3, 4, 10)
plot(CONTOUR)
hold on
plot(Dnoise,Color='r');title("Output Noise");text('Units', 'normalized', 'String', '(f)', 'Position',[0.01 0.93 0], 'FontSize', 12);
legend('Noisy data','Reconstructed signal')
subplot(3, 4, 3)
...
legend('High-quality data','Reconstructed signal')
